...
public class MainActivity extends FragmentActivity implements
    ...
    void handleSendText(Intent intent) {
        ...
        if (sharedText != null) {
            Log.d("butterfly", "sharedText: "+ sharedText);
            final Entry entry = this.createEntry(sharedText);
            //showRecordingFragment(true);
            Log.d ("butterfly", "created entry.  entry.getFullTranscription():" + entry.getFullTranscription());
            this.CreateEntry(entry);
        } else {
            Log.d("butterfly", "sharedText was null!?!?!?");
        }
    }
    ...
    protected void handleIntent(Intent intent) {
        ...
        if (intent != null) {
            ...
            if (NoteIntents.ACTION_CREATE_NOTE.equals(action)) {
                ...
                Log.d ("butterfly", "Handling ACTION_SEND intent!");
                if ("text/plain".equals(type)) {
                    Log.d ("butterfly", "Type: text/plain!");
                    handleSendText(intent); // Handle text being sent
                } else if (type.startsWith("image/")) {
                    Log.d ("butterfly", "Type: image!");
                ...
                Log.d ("butterfly", "Launched regularly!");
            } else {
                // Handle other intents, such as being started from the home screen
                Log.d ("butterfly", "Launched with unexpected intent. ");
            }
        } else {
